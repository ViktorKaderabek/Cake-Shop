...
class ProductsActivity : AppCompatActivity()
{
	...
	val cakesIntent =
	     Intent(this,
		  CakesActivity::class.java)
	val iceCreamIntent =
	     Intent(this,
		  IceCreamActivity::class.java)
	val dessertsIntent =
	     Intent(this,
		  DesertsActivity::class.java)
	...
	productViewModel.fastAdapter.onClickListener = { view, adapter, item, position ->
	     ...
	     if (position == 0)
	     {
		startActivityForResult(cakesIntent,
				   1)
	     }
	     else if (position == 1)
	     {
		startActivityForResult(iceCreamIntent,
				   1)
	     }
	     else if (position == 2)
	     {
		startActivityForResult(dessertsIntent,
				   1)
	     }
	     false
	}
